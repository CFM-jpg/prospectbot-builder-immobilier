...
const ONBOARDING_STEPS = [
 ...
 { id: 'biens', icon: '', title: 'Les annonces', desc: 'ProspectBot scrape automatiquement LeBonCoin, SeLoger et BienIci pour récupérer les nouvelles annonces. Vous pouvez aussi importer des biens manuellement.', highlight: 'Onglet "Annonces" dans la sidebar' },
 ...
 { id: 'emails', icon: '', title: 'Alertes email automatiques', desc: 'Quand un bien correspond à plus de 60% aux critères d\'un acheteur, un email lui est envoyé automatiquement via Brevo. Vous pouvez aussi envoyer manuellement.', highlight: 'Onglet "Emails"' },
